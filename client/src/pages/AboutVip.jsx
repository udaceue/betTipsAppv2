...
function AboutVip() {
  ...
  <div className="content">
   Premium  Vip Users
    <div className="sub header vipAbout">Here's what you will get by joining to our vip users</div>
  ...
  <div className="ui inverted relaxed divided list">
    ...
    <div className="item">
      <div className="content">
        <div className="header vipHeaderList"> - Private Vip Chat</div>
        You will be added to our private group on Telegram. To exchange insights and knowledge with other users of our community.
      </div>
    </div>
    <div className="item">
      <div className="content">
        <div className="header vipHeaderList"> - More Disciplines</div>
        Tips from other disciplines like tenis, hokey, martial arts and more...
      </div>
    </div>
    <div className="item">
      <div className="content">
        <div className="header vipHeaderList"> - Full Bets History</div>
            Do you wanna how much you won or lost with our bets?
            Would you like to know your yield? Get Vip Today!
      </div>
    </div>
  </div>
            ...
            <div className="header"> To Buy vip you need to dm me at xdxdx@xdxdxdxd.com
              or by 
